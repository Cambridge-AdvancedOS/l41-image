 ...
 */
uint32_t __efi_runtime crc32_no_comp(uint32_t crc, const uint8_t *buf, u_int len)
{
...
uint32_t __efi_runtime crc32(uint32_t crc, const uint8_t *p, u_int len)
{
 ...
 * of input.
 */
uint32_t crc32_wd(uint32_t crc, const unsigned char *buf, u_int len,
		  u_int chunk_sz)
{
